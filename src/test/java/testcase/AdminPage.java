...
public class AdminPage extends BaseTest {
	...
	public void searchSystemUsers() {
		...
		driver.findElement(By.xpath("//div[@class='oxd-form-row']//div[1]//div[1]//div[1]//div[2]//input")).sendKeys("Garry.White");
		driver.findElement(By.xpath("//button[@class='oxd-button oxd-button--medium oxd-button--secondary orangehrm-left-space' and @type='submit']")).click();
